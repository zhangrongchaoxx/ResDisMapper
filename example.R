####安装##############
#mamba create -n r-ResDisMapper.1.1 r-base   r-ggplot2   r-adegenet   r-poppr   r-raster   r-rgl   r-rmisc   r-sp   git
#install.packages("/home/zhangrongchao/git_hub/ResDisMapper", repos = NULL, type = "source")
######################

#激活环境 conda activate r-ResDisMapper.1.1
